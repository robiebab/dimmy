...
class Util {
   ...
   * @param {number} [timeoutMillis=10000]
   * @param {string} [message="Timeout after 10000ms"]
   * @returns {Promise}
   */
  static async timeout(promise, timeoutMillis = 10000, message = `Timeout after ${timeoutMillis}ms`) {
